...
class VoxelBackLite(nn.Module):
    def __init__(self, input_channels, out_channels, grid_size):
        super().__init__()
        ...
        self.conv_out = spconv.SparseSequential(
            spconv.SubMConv3d(64, out_channels, (1, 1, 1), stride=(1, 1, 1), padding=last_pad,
