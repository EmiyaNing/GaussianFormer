...
model = dict(
    ...
    encoder=dict(
        ...
        num_densify_frame_decoder=num_densify_frame_decoder,
        operation_order=[
            "deformable",
            "ffn",
            "norm",
            ...
            "norm",
            "refine",
        ] * (num_decoder - num_densify_frame_decoder - num_single_frame_decoder),
    ),
    head=dict(
        type='GaussianHead',
