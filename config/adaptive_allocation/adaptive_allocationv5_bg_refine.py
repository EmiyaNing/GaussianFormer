...
optimizer = dict(
    optimizer = dict(
        type="AdamW", lr=2e-5, weight_decay=0.01,
    ),
)
onecyclelr = True
grad_max_norm = 35
...
scale_range = [0.08, 1.28]
xyz_coordinate = 'cartesian'
phi_activation = 'sigmoid'
include_opa = True
load_from = 'ckpts/adaptive_allocationv4.pth'
semantics = True
semantic_dim = 17
...
model = dict(
    ...
    freeze_encoder_except_densify=True,
    freeze_encoder_anchor_encoder=True,
